...
import { Github, Key, CheckCircle, AlertCircle, Eye, EyeOff, RefreshCw } from "lucide-react"
        ...
        <div className="space-y-4">
          {hasExistingToken && (
            <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-green-800">GitHub token is active</span>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="token">{hasExistingToken ? "New GitHub Token" : "GitHub Token"}</Label>
