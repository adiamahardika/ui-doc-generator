...
export default function ActivityLogPage() {
    ...
    setTimeout(() => {
      const mockActivities: ActivityLog[] = [
        ...
        },
        {
          ...
          actionType: "generate",
          details:
            "Generated documentation for 3 files in react-dashboard repository",
        ...
        },
        {
          ...
          actionType: "download",
          details:
            "Downloaded documentation ZIP file (react-dashboard-documentation.zip)",
        ...
        },
        {
          ...
          details:
            "Created new user account for Bob Wilson (bob.wilson@example.com)",
        ...
        },
        {
          ...
          actionType: "generate",
          details:
            "Generated documentation for 1 file in python-api-server repository",
  ...
  useEffect(() => {
    ...
    if (actionFilter !== "all") {
      filtered = filtered.filter(
        (activity) => activity.actionType === actionFilter
      );
    }
